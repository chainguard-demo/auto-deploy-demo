...
|---|---|---|---|---|
| `CVE-2026-31789` | `libcrypto3` | `3.6.0-r0` | `(unknown)` | **Critical** |
| `CVE-2026-31789` | `libssl3` | `3.6.0-r0` | `(unknown)` | **Critical** |
| `CVE-2026-6100` | `python-3.12` | `3.12.11-r8` | `3.12.13-r3` | **Critical** |
| `CVE-2026-6100` | `python-3.12-base` | `3.12.11-r8` | `3.12.13-r3` | **Critical** |
...
| `CVE-2025-15467` | `libcrypto3` | `3.6.0-r0` | `3.6.1-r0` | **High** |
| `CVE-2025-15467` | `libssl3` | `3.6.0-r0` | `3.6.1-r0` | **High** |
...
| `CVE-2026-2673` | `libcrypto3` | `3.6.0-r0` | `3.6.1-r3` | **High** |
| `CVE-2026-2673` | `libssl3` | `3.6.0-r0` | `3.6.1-r3` | **High** |
| `CVE-2026-28386` | `libcrypto3` | `3.6.0-r0` | `(unknown)` | **High** |
| `CVE-2026-28386` | `libssl3` | `3.6.0-r0` | `(unknown)` | **High** |
| `CVE-2026-28387` | `libcrypto3` | `3.6.0-r0` | `(unknown)` | **High** |
| `CVE-2026-28387` | `libssl3` | `3.6.0-r0` | `(unknown)` | **High** |
| `CVE-2026-28388` | `libcrypto3` | `3.6.0-r0` | `(unknown)` | **High** |
| `CVE-2026-28388` | `libssl3` | `3.6.0-r0` | `(unknown)` | **High** |
| `CVE-2026-28389` | `libcrypto3` | `3.6.0-r0` | `(unknown)` | **High** |
| `CVE-2026-28389` | `libssl3` | `3.6.0-r0` | `(unknown)` | **High** |
| `CVE-2026-28390` | `libcrypto3` | `3.6.0-r0` | `(unknown)` | **High** |
| `CVE-2026-28390` | `libssl3` | `3.6.0-r0` | `(unknown)` | **High** |
| `CVE-2026-31790` | `libcrypto3` | `3.6.0-r0` | `(unknown)` | **High** |
| `CVE-2026-31790` | `libssl3` | `3.6.0-r0` | `(unknown)` | **High** |
| `CVE-2026-3298` | `python-3.12` | `3.12.11-r8` | `(unknown)` | **High** |
...
| `CVE-2026-5928` | `glibc` | `2.42-r1` | `(unknown)` | **High** |
...
| `CVE-2026-3644` | `python-3.12` | `3.12.11-r8` | `(unknown)` | **Medium** |
| `CVE-2026-4224` | `python-3.12` | `3.12.11-r8` | `(unknown)` | **Medium** |
...
| `CVE-2026-5358` | `glibc` | `2.42-r1` | `2.43-r6` | **Unknown** |
| `CVE-2026-5358` | `glibc-locale-posix` | `2.42-r1` | `2.43-r6` | **Unknown** |
| `CVE-2026-5358` | `ld-linux` | `2.42-r1` | `2.43-r6` | **Unknown** |
| `CVE-2026-5358` | `libcrypt1` | `2.42-r1` | `2.43-r6` | **Unknown** |
...
| `GHSA-jj2g-xq7w-gf88` | `glibc` | `2.42-r1` | `2.43-r6` | **Unknown** |
| `GHSA-jj2g-xq7w-gf88` | `glibc-locale-posix` | `2.42-r1` | `2.43-r6` | **Unknown** |
| `GHSA-jj2g-xq7w-gf88` | `ld-linux` | `2.42-r1` | `2.43-r6` | **Unknown** |
| `GHSA-jj2g-xq7w-gf88` | `libcrypt1` | `2.42-r1` | `2.43-r6` | **Unknown** |
...
glibc        2.43-r6               apk   CVE-2026-5928   High        
python-3.12  3.12.13-r3            apk   CVE-2026-3298   High        
python-3.12  3.12.13-r3            apk   CVE-2025-15366  Medium      
python-3.12  3.12.13-r3            apk   CVE-2025-15367  Medium      
python-3.12  3.12.13-r3            apk   CVE-2026-2297   Medium      
python-3.12  3.12.13-r3            apk   CVE-2026-3446   Medium      
python-3.12  3.12.13-r3            apk   CVE-2026-3644   Medium      
python-3.12  3.12.13-r3            apk   CVE-2026-4224   Medium      
python-3.12  3.12.13-r3            apk   CVE-2025-13462  Low         
python-3.12  3.12.13-r3            apk   CVE-2026-3479   Negligible
```

## Prisma Cloud

https://app.prismacloud.io/compute?computeState=/monitor/vulnerabilities/images/ci?search%3Dsha256%253Af706798993cbe326194fb13848bd8666e03cd60b31050b488a9811f3dbb80aad
